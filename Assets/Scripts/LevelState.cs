...
public class LevelState : MonoBehaviour {
    ...
    void createButtons(char[] a)
    {
        ...
        {
            GameObject button1 = (GameObject)Instantiate(button, new Vector3(Camera.main.transform.position.x + 7, Camera.main.transform.position.y + 4 - i), Quaternion.identity);
